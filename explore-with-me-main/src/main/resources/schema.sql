...
(
    ...
    comment_text       VARCHAR(2047)               NOT NULL,
    comment_created_on TIMESTAMP WITHOUT TIME ZONE NOT NULL,
    comment_state      VARCHAR(127) DEFAULT 'PENDING',
    CONSTRAINT pk_comment PRIMARY KEY (comment_id),
    CONSTRAINT fk_comment_event FOREIGN KEY (comment_event_id) REFERENCES event (event_id),
    CONSTRAINT fk_comment_users FOREIGN KEY (comment_author_id) REFERENCES users (user_id),
    CONSTRAINT not_empty_comment_text CHECK (LENGTH(comment_text) > 0)
);
